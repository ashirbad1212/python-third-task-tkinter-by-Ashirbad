...
class StudentApp(tk.Tk):         #student application
    ...
    def __init__(self):
        ...
        container.grid_rowconfigure(0, weight=1)        #for row
        container.grid_columnconfigure(0, weight=1)   #for column
...
class Login(tk.Frame):   #login class having attributes as user name,password,submit
